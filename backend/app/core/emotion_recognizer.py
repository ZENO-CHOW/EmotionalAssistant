...
class EmotionRecognizer:
    ...
    def analyze_text_emotion(
        ...
        try:
            ...
            if emotion_scores:
                ...
                confidence = min(emotion_scores[emotion_type] / 3.0, 1.0)  # 归一化置信度
            ...
            result = {
                ...
                "reason": f"基于关键词匹配识别：{emotion_scores}" if emotion_scores else "未识别到明确情绪关键词"
            }
    ...
    def process_image_selection(self, image_ids: List[str]) -> Dict:
        ...
        try:
            ...
            if emotion_counts:
                emotion_type = max(emotion_counts, key=emotion_counts.get)
